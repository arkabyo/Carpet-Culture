                ...
                <div>
                    ...
                    <form name="add" action="" method="post">
                        ...
                        <select name="dolly2" id="dolly2" class="v" required>
                            ...
                            <option value="Dolly-23">Dolly-23</option>                           
                            <option value="Dolly-23A">Dolly-23A (Basement)</option>
                            <option value="Dolly-23B">Dolly-23B (Basement)</option>
                            ...
                            <option value="Basement-1 Row-1">Basement-1 Row-1</option>
                            <option value="Basement-1 Row-2">Basement-1 Row-2</option>
                            <option value="Basement-1 Row-3">Basement-1 Row-3</option>
                            <option value="Basement-1 Row-4">Basement-1 Row-4</option>
                            <option value="Basement-1 Row-5">Basement-1 Row-5</option>
                            <option value="Basement-1 Row-6">Basement-1 Row-6</option>
                            <option value="Basement-1 Row-7">Basement-1 Row-7</option>
                            <option value="Basement-2 Row-1">Basement-2 Row-1</option>
                            <option value="Basement-2 Row-2">Basement-2 Row-2</option>
                            <option value="Basement-2 Row-3">Basement-2 Row-3</option>
                            <option value="Basement-2 Row-4">Basement-2 Row-4</option>
                            <option value="Basement-2 Row-5">Basement-2 Row-5</option>
                            <option value="Basement-2 Row-6">Basement-2 Row-6</option>
                            <option value="Basement-2 Row-7">Basement-2 Row-7</option>
                            <option value="Basement-2 Row-8">Basement-2 Row-8</option>
                            <option value="Basement-2 Row-9">Basement-2 Row-9</option>
                            <option value="Basement-2 Row-10">Basement-2 Row-10</option>
                            <option value="Basement-2 Row-11">Basement-2 Row-11</option>
                        </select>&nbsp; &nbsp;
                        <br><br>
